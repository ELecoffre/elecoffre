...
class ContentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create content" do
    assert_difference('Content.count') do
      post contents_url, params: { content: { contenu: @content.contenu, name: @content.name } }
    end
  ...
  test "should update content" do
    patch content_url(@content), params: { content: { contenu: @content.contenu, name: @content.name } }
